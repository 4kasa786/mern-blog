...
export const updateUser = async (req, res, next) => {
    ...
    if (req.body.password) {
        ...
        if (req.body.password.length > 20) {
            return next(errorHandler(400, "Password must be at most 20 characters long"));
        }
...
export const getUsers = async (req, res, next) => {
    ...
    if (!req.user.isAdmin) {
        return next(errorHandler(403, "You are not allowed to access all the Users"));
    }
    ...
    try {
        ...
        // console.log(error);
        next(errorHandler(500, "Error while getting users"));
    }
...
export const getUser = async (req, res, next) => {
    try {
        ...
        next(errorHandler(500, "Error while getting the user"));
    }
}